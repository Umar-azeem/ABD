...
const [isVisible, setIsVisible] = useState(true)
  ...
  return (
   <div className="bg-gradient-to-r from-black via-black to-yellow-500 text-yellow-300 py-2 relative overflow-hidden">
  <div className="overflow-hidden whitespace-nowrap">
    <div className="animate-marquee inline-block">
      <span className="mx-8">🎉 Welcome to Abdullah - Your Fashion Destination!</span>
