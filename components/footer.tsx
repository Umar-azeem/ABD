...
export function Footer() {
  ...
  const socialLinks = [
    
    {
      name: "Instagram",
      icon: Instagram,
      url: "https://www.instagram.com/abdullah.______.op?utm_source=ig_web_button_share_sheet&igsh=NHBpcmxvNGU0M3Nz",
      color: "hover:text-pink-600",
    },
    {
      name: "WhatsApp",
      icon: MessageCircle,
      url: "https://wa.me/03020650052",
...
Time: ${new Date().toLocaleTimeString()}`;
      ...
      const whatsappUrl = `https://wa.me/+923020650052?text=${encodeURIComponent(
        whatsappMessage
      )}`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <p className="text-xs text-muted-foreground">jewellers</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-1 md:px-4 py-2">
        <div className="flex flex-col md:flex-row justify-between items-center md:space-y-2 space-y-0">
          <div className="text-sm gap-2 hidden md:flex text-gray-400">
            ©{currentYear} ABDULLAH jeweller All rights reserved.
          </div>
